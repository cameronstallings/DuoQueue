...
- **You have the legal capacity to enter this agreement** and are not barred from using the Service under the laws of your jurisdiction or ours.
...
- **Sexual content involving minors.** Zero tolerance. Any content that sexualizes, exploits, or endangers a minor — including a user appearing to be a minor — will be removed immediately, the account will be permanently banned, and **we will report it to the National Center for Missing & Exploited Children (NCMEC) and/or law enforcement as required by law.** We mean this literally: don't test the boundaries of this rule.
