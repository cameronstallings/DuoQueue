...
- **Tab bar**: solid `colors.surfaceSolid`, top seam; labels Plex Mono 8.5px; active = volt icon+label, inactive `colors.textMuted`. Active tab tile treatment (34×28 tile) becomes a volt underline bar instead.
